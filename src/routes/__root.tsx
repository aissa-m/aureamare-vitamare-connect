...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AureaMare Holding × VitaMare" },
      { name: "description", content: "Importación y exportación de pescado fresco y congelado desde Mauritania al mercado europeo." },
      { name: "author", content: "AureaMare Holding" },
